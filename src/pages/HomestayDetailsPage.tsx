...
import {
  MapPin, Users, Star, Wifi, UtensilsCrossed, Image, MapIcon, 
  MessageCircle, Calendar as CalendarIcon, BedDouble, Waves, 
  MapPinned, Palette, TreePalm, Car, Droplet, Footprints , Leaf,
  Bike, Sparkles, Fan, PawPrint, Baby, Mountain, Fish,
  Rabbit, Flame, Telescope, Home, TentTree 
} from 'lucide-react';
...
const HomestayDetailsPage = () => {
  ...
  const stayDuration = checkInDate && checkOutDate ? differenceInDays(checkOutDate, checkInDate) + 1 : 0;
                ...
                <div className="py-6">
                  ...
                  {homestay.location_description && (
                    <div className="mt-4">
                      ...
                      <p className="text-muted-foreground">{homestay.location_description}</p>
                    </div>
                  )}
                </div>
              </TabsContent>
    ...
    <div className="grid grid-cols-2 gap-4">
      {homestay.amenities.map((amenity, index) => {
        const amenitiesIcons = {
          ...
          'Traditional Meals': <UtensilsCrossed size={18} className="mr-2" />,
          'Lake View': <Waves size={18} className="mr-2" />,
          'Guided Tours': <MapPinned size={18} className="mr-2" />,
          'Cultural Activities': <Palette size={18} className="mr-2" />,
          'Garden': <TreePalm size={18} className="mr-2" />,
          'Free Parking': <Car size={18} className="mr-2" />,
          'Hot Water': <Droplet size={18} className="mr-2" />,
          'Trekking Tours': <Footprints size={18} className="mr-2" />,
          ...
          'Mountain View': <Mountain size={18} className="mr-2" />,
        ...
        const Icon = amenitiesIcons[amenity as keyof typeof amenitiesIcons] || <Home size={18} className="mr-2" />;
              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button variant="outline" className="w-full">
                        <CalendarIcon className="mr-2 h-4 w-4" />
                        {checkOutDate ? format(checkOutDate, 'PP') : 'Check-out'}
                      </Button>
                    </PopoverTrigger>
                    <PopoverContent className="w-auto p-0">
                      <Calendar
                ...
                <div className="mb-6 flex items-start space-x-2">
                  ...
                  <Label htmlFor="policy" className="text-sm font-normal leading-snug">
                    I agree to the booking and cancellation policy. Cancellations within 48 hours of check-in incur a 50% charge.
                  </Label>
                </div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span>₹{selectedRoom.price} × {stayDuration} nights</span>
                    <span>₹{subtotal}</span>
                  </div>
                  <div className="flex justify-between">
        ...
        <div className="py-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherHomestays.map((home) => (
              <div key={home.id} className="border rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                <img 
                  src={home.images[0]} 
                  alt={home.name}
