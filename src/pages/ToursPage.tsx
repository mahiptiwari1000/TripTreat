...
const tours = [
  {
    ...
    description:
      'Explore the iconic Loktak Lake with its floating phumdis and visit Keibul Lamjao National Park to spot the endangered Sangai deer.',
  ...
  },
  {
    ...
    description:
      'Discover the rich history and culture of Imphal through this guided walking tour of historical sites, including Kangla Fort and Ima Market.',
  ...
  },
  {
    ...
    description:
      'Experience the stunning beauty of Dzukou Valley, known for its vibrant flowers and rolling hills. This trek offers breathtaking views and a unique natural landscape.',
  ...
  },
  {
    ...
    description:
      'Trek to the habitat of the rare and beautiful Shirui Lily, which blooms only in the Shirui Hills of Manipur during the early monsoon season.',
  ...
  },
  {
    ...
    location: 'Imphal, Manipur',
    description:
      'Sample the flavors of Manipuri cuisine with visits to local markets, street food stalls, and a cooking demonstration of traditional dishes.',
  ...
  },
  {
    ...
    description:
      'Visit the bustling border town of Moreh on the India-Myanmar border, known for its vibrant markets and cultural diversity.',
      ...
      <div className="relative h-[300px] mb-8">
        ...
        <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center">
          ...
          <p className="text-xl text-white/90">
            Explore the beauty and culture of Manipur with expert local guides
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-3">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">
                Discover unique experiences in Manipur
              </p>
            </div>
