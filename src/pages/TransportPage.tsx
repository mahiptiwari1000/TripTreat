...
const TransportPage = () => {
  ...
  const handleOptionSelect = (optionId: string) => {
    ...
    toast.info(
      `${optionId === 'cab' ? 'Cab booking' : 'Vehicle rental'} dialog opened`,
      {
        ...
        <div className="space-y-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8 animate-fade-in">
              Explore Manipur with ease using our reliable transportation
              services. Choose between booking a cab or renting a vehicle for
              your convenience.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-background p-4 rounded-lg shadow-sm">
                ...
                <p className="text-sm text-muted-foreground">
                  Well-maintained vehicles and professional drivers ensuring
                  your safety.
                </p>
              </div>
              <div className="bg-background p-4 rounded-lg shadow-sm">
                ...
                <p className="text-sm text-muted-foreground">
                  Easy booking process with flexible scheduling and pickup
                  options.
                </p>
              </div>
              <div className="bg-background p-4 rounded-lg shadow-sm">
                ...
                <p className="text-sm text-muted-foreground">
                  Our drivers are locals who know the best routes throughout
                  Manipur.
                </p>
              </div>
            </div>
