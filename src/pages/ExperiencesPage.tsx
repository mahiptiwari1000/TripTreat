...
import { MapPin, Clock, Star, Users, Calendar as CalendarIcon, Info } from 'lucide-react';
...
const experiences = [
  {
    ...
    included: ['All ingredients', 'Recipe booklet', 'Tea and snacks', 'Cooking equipment']
  },
  {
    id: 2,
  ...
  },
  {
    ...
    included: ['Dance costume rental', 'Professional instruction', 'Certificate of participation', 'Cultural refreshments']
  },
  {
    id: 4,
    ...
    included: ['Materials', 'Small loom to take home', 'Finished product to keep', 'Refreshments']
  },
  {
    id: 5,
    ...
    included: ['Transportation to viewpoint', 'Professional photography tips', 'Breakfast picnic', 'Hot beverages']
  },
  {
    id: 6,
    ...
    included: ['All materials', 'Firing of your creation', 'Village tour', 'Traditional lunch']
  }
];

const categories = ['All', 'Culinary', 'Nature', 'Cultural', 'Crafts', 'Photography'];
    ...
    <div className="min-h-screen">
      ...
      <div className="relative h-[300px] mb-8">
        ...
        <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-2 animate-fade-in">Authentic Experiences</h1>
          <p className="text-xl text-white/90 animate-fade-in transition-all duration-500 delay-150">Immerse yourself in the culture and traditions of Manipur</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
              ...
              <TabsContent key={category} value={category} className="mt-0">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredExperiences.map((experience) => (
                    <Card key={experience.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-300 hover:scale-[1.01] group">
                      <div className="relative h-48 overflow-hidden">
                        ...
                        <div className="absolute top-3 right-3 bg-white/90 rounded-full px-2 py-1 text-sm font-semibold flex items-center">
                          ...
                          {experience.rating} <span className="text-muted-foreground ml-1">({experience.reviews})</span>
                        </div>
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-center mb-3">
                          ...
                          />
                          <div>
                            <h4 className="text-sm font-medium">Hosted by {experience.host}</h4>
                          </div>
                        </div>
        ...
        <div className="bg-muted/30 rounded-lg p-8 text-center mt-12">
          <h2 className="text-2xl font-bold mb-4">Want to Host Your Own Experience?</h2>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Share your skills, knowledge, or unique cultural perspective with travelers. 
            Become a host and earn while showcasing the best of Manipur.
          </p>
          <Button 
