import React, { useState, useEffect } from 'react';
 ...
 const PlannedTours: React.FC = () => {
   ...
   if (isLoading) {
     return <div className="flex justify-center items-center p-8">Loading your planned tours...</div>;
   }
         ...
         <CardContent className="pt-6">
           <div className="text-center py-8">
             ...
             <p className="mt-2 text-sm text-muted-foreground">
               You haven't saved any tour plans yet. Use our chatbot to plan your next Manipur adventure!
             </p>
           </div>
         </CardContent>
       </Card>
       ...
       <Dialog open={showDialog} onOpenChange={setShowDialog}>
         <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
           <DialogHeader>
             ...
             <DialogDescription>
               Created on {selectedTour && format(new Date(selectedTour.created_at), 'PPP')}
             </DialogDescription>
           </DialogHeader>
