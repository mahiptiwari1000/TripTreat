...
const homestays = [
  {
    ...
    description:
      'Enjoy panoramic views of the floating phumdis on Loktak Lake in this traditional Manipuri home.',
  ...
  },
  {
    ...
    description:
      'Experience royal Manipuri hospitality in this heritage home with traditional architecture.',
  ...
  },
  {
    ...
    description:
      'Nestled in the hills of Ukhrul, this cozy retreat offers stunning mountain views and tranquility.',
    ...
    <section className="py-16 bg-muted/50">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-muted-foreground mb-10 max-w-2xl mx-auto">
          Live like a local in our handpicked homestays offering authentic
          Manipuri experiences
        </p>
