                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Capture stunning views and unique cultural moments
                          that make for perfect travel memories.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Get a genuine taste of local culture, traditions, and
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          This location is highly recommended by locals and
                          experienced travelers for its unique charm.
                        </p>
                      </div>
                    </div>
                  </div>
