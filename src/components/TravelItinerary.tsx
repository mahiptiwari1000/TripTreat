  ...
  const formatItineraryContent = (text: string) => {
    ...
    return lines.map((line, index) => {
      ...
      if (trimmed.startsWith('Total Budget:')) {
        ...
        return (
          <div key={index} className="text-center mb-6">
            <h1 className="text-2xl font-bold text-gray-800">Travel Itinerary for Manipur, India</h1>
      ...
      if (trimmed.startsWith('Day ')) {
        return (
          <h2 key={index} className="text-xl font-bold mt-6 mb-3 text-blue-800">
      ...
      <CardContent className="pt-4">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Button
            ...
            onClick={() => {
              const blob = new Blob([getPrintableContent()], { type: 'text/plain' });
